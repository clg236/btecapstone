...
const BTEHomePage = () => {
  ...
  const aboutContent = [
    'The Business Technology and Entrepreneurship Capstone is a culminating course...',
    'Students develop innovative solutions to real-world business problems...',
    'Projects showcase technical skills and entrepreneurial mindsets...',
    'Industry partnerships provide authentic learning experiences...',
    'Final presentations demonstrate business acumen and technical proficiency...',
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="w-full relative">
        ...
        <div className="w-full h-[500px] relative overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <img 
              src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3540&q=80" 
              alt="Team of students working together" 
          ...
          <div className="relative z-10 w-full h-full flex flex-col justify-center items-center text-center px-4">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Business Technology and Entrepreneurship Capstone
            </h1>
            <p className="text-xl text-white max-w-3xl">
              Showcasing innovative projects from the next generation of tech leaders and entrepreneurs
            </p>
            <div className="mt-8">
              <Link 
                href="#projects" 
                className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-md shadow-md transition-colors"
              >
                Explore Projects
              </Link>
            </div>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/4 bg-white p-6 shadow-md h-fit">
                  ...
                  <div className="p-5 flex flex-col justify-between items-start relative">
                    ...
                    <div className="flex -space-x-4 mt-2">
                      {project.teamAvatars.map((avatar, index) => (
                        ...
                        >
                          {/* Using a div with background for now, can be replaced with Image component */}
                          <div 
        ...
        <div className="mt-12 bg-blue-600 text-white p-8 rounded-lg shadow-md flex justify-between items-center">
          ...
          <div>
            {/* Storm Logo Placeholder */}
            <div className="w-16 h-16 bg-white rounded flex items-center justify-center">
              <span className="text-blue-600 font-bold text-xs">Storm Logo</span>
            </div>
          </div>
        </div>
      </main>
